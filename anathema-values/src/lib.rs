...
pub use self::expressions::{Expression, Immediate, Resolver, Visibility};
pub use self::id::{NextNodeId, NodeId};
pub use self::path::Path;
pub use self::scope::Context;
pub use self::signals::{List, Map, Value, ValueRef};
pub use self::slab::Slab;
pub use self::state::State;
pub use self::value::{Num, Static};
...
// pub trait DynValue {
//     fn init_value(context: &Context<'_>, node_id: &NodeId, expr: &Expression) -> Value<Self>
//     where
//         Self: Sized;

//     fn resolve(value: &mut Value<Self>, context: &Context<'_>, node_id: &NodeId)
//     where
//         Self: Sized;
// }
