...
impl RootScope {
    ...
    fn insert_at(&mut self, ident: impl Into<Rc<str>>, var: VarId, id: impl AsRef<[u16]>) {
...
impl Declarations {
    ...
    fn add(
        &mut self,
        ident: impl Into<Rc<str>>,
        id: impl Into<ScopeId>,
        value_id: impl Into<VarId>,
    ) {
...
impl Variables {
    ...
    pub fn declare(&mut self, ident: impl Into<Rc<str>>, value: Expression) -> VarId {
...
mod test {
    ...
    fn variable_declaration() {
        ...
        let expected = Expression::from(123);
